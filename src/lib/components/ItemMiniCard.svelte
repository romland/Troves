...
<a href="/{item.id}/{item.slug || 'view'}" class="flex items-center gap-3 bg-base-100 border border-base-200 p-2 rounded-xl shadow-sm w-full text-left group hover:border-primary/30 transition-colors">
