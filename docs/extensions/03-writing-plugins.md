...
You can provide human-readable metadata for your plugin directly in the file using a JSDoc comment block at the very top. This requires zero configuration, is completely optional, and will be parsed by the system to display in the Plugin Manager UI.
